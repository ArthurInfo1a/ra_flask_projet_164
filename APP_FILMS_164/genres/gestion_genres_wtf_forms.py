...
class FormWTFAjouterGenres(FlaskForm):
    ...
    nom_genre_wtf = StringField("Insèrer le genre ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFUpdateGenre(FlaskForm):
    ...
    prenom_personne_update_wtf = StringField("Clavioter le nom de la personne ",
